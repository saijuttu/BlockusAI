...
public class ServersListener implements Runnable
{
    ...
    public ServersListener(ObjectOutputStream os, ObjectInputStream is)
    {
        ...
        // Adds testing AIs
        testingAIsAsOrange.add(new HAL_9000(board.ORANGE, "HAL_9000"));
        testingAIsAsPurple.add(new HAL_9000(board.PURPLE, "HAL_9000"));
...
//        testingAIsAsPurple.add(new BigMoverAI(board.PURPLE, "Servers Big Mover AI"));
        ...
        fourthPeriodAIsAsOrange.add(new HAL_9000(BlokusBoard.ORANGE, "HAL_9000 AI"));
        fourthPeriodAIsAsPurple.add(new HAL_9000(BlokusBoard.PURPLE, "HAL_9000 AI"));
