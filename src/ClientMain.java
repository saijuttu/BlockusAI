...
public class ClientMain
{
    ...
    //public static final String ip = "127.0.0.1    T155201 ";
    public static final String ip = "T155189";
    ...
    public static void main(String[] args)
    {
        ...
        Player myAIasOrange = new HAL_9000(BlokusBoard.ORANGE, "Clients AI");
        Player myAIasPurple = new HAL_9000(BlokusBoard.PURPLE, "Clients AI");
